...
namespace lime {
	...
	class Window {
		...
		public:
			...
			virtual bool SetVSyncMode (bool vsync) = 0;
			virtual void SetCursor (Cursor cursor) = 0;
			virtual void SetDisplayMode (DisplayMode* displayMode) = 0;
			virtual bool SetFullscreen (bool fullscreen) = 0;
			virtual bool SetDarkMode (bool darkMode) = 0;
			virtual bool SetHideInTab (bool hideInTab) = 0;
			virtual bool SetTransparent (bool transparent, bool clickThrough) = 0;
			virtual void RemoveButtons () = 0;
			virtual void SetBorderColor (int r, int g, int b) = 0;
